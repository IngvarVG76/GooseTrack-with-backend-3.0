...
`,Ue={phone:{notFoundPhonepng:se,notFoundPhonepng2x:oe,notFoundPhonewebp:re,notFoundPhonewebp2x:ae},tablet:{notFoundTabletpng:ie,notFoundTabletpng2x:ce,notFoundTabletwebp:ue,notFoundTabletwebp2x:pe},desktop:{notFoundDesktoppng:le,notFoundDesktoppng2x:fe,notFoundDesktopwebp:de,notFoundDesktopwebp2x:ge}},{phone:I,tablet:L,desktop:O}=Ue,Me=()=>{const{t}=De(),e=me();return F.jsxs(Ke,{style:{backgroundColor:e.colors.primaryBackground},children:[F.jsxs(Re,{children:[F.jsx(M,{children:"4"}),F.jsxs(We,{children:[F.jsx("source",{type:"image/webp",media:"(max-width: 767px)",srcSet:`${I.notFoundPhonewebp} 1x, ${I.notFoundPhonewebp2x} 2x`}),F.jsx("source",{type:"image/webp",media:"(max-width: 1439px)",srcSet:`${L.notFoundTabletwebp} 1x, ${L.notFoundTabletwebp2x} 2x`}),F.jsx("source",{type:"image/webp",media:"(min-width: 1440px)",srcSet:`${O.notFoundDesktopwebp} 1x, ${O.notFoundDesktopwebp2x} 2x`}),F.jsx("source",{type:"image/png",media:"(max-width: 767px)",srcSet:`${I.notFoundPhonepng} 1x, ${I.notFoundPhonepng2x} 2x`}),F.jsx("source",{type:"image/png",media:"(max-width: 1439pxpx)",srcSet:`${L.notFoundTabletpng} 1x, ${L.notFoundTabletpng2x} 2x`}),F.jsx("source",{type:"image/png",media:"(min-width: 1440px)",srcSet:`${O.notFoundDesktoppng} 1x, ${O.notFoundDesktoppng2x} 2x`}),F.jsx("img",{src:`${I.notFoundPhonepng}`,alt:"ErrorImage"})]}),F.jsx(M,{children:"4"})]}),F.jsx(Ve,{style:{color:e.colors.text},children:F.jsx(ze,{i18nKey:"notfound.text",children:"We’re sorry, the page you requested could not be found. Please go back to the homepage."})}),F.jsx(Je,{to:"/",style:{backgroundColor:e.backgroundButton,color:e.textButton},children:t("Back to home")})]})};function Xe(){return F.jsx(Me,{})}export{Xe as default};
