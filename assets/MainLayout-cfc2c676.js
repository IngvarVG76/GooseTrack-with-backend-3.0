...
`,gn=s.button`
  ...
  border: none;
  font-size: 16px;
`,Z="feedback",vn=()=>{var d;const[e,t]=h.useState(()=>{var v;return((v=JSON.parse(window.localStorage.getItem(Z)))==null?void 0:v.rating)??5}),[o,a]=h.useState(!1),[l,i]=h.useState(!1),[c,m]=h.useState({review:((d=JSON.parse(window.localStorage.getItem(Z)))==null?void 0:d.review)??""}),r=at({initialValues:c,validationSchema:st({review:rt().max(300,"Must be 300 characters or less").trim().required("Fill in the field! Your feedback is very important to us")}),onSubmit:({review:v})=>{const u=v.trim();a(!0),i(!1),window.localStorage.setItem(Z,JSON.stringify({review:u,rating:e})),m({review:u})}});return n.jsxs(cn,{children:[n.jsx(dn,{children:"Rating"}),n.jsx(Mt,{spacing:1,children:n.jsx(Gt,{name:"text-feedback",value:e,disabled:o,onChange:(v,u)=>{t(u)},precision:.5,emptyIcon:n.jsx(je,{style:{opacity:.55},fontSize:"inherit"})})}),n.jsxs(pn,{onSubmit:r.handleSubmit,children:[n.jsx("label",{htmlFor:"firstName",children:n.jsx(un,{children:"Review"})}),n.jsx(hn,{"data-error":r.errors.review,id:"review",name:"review",type:"text",disabled:o,placeholder:"Enter text",onChange:r.handleChange,onBlur:r.onBlur,value:r.values.review}),r.errors.review&&n.jsx(mn,{children:r.errors.review}),!o&&c.review===""&&n.jsxs(pe,{children:[n.jsx(ue,{type:"submit",children:"Save"}),n.jsx(he,{type:"button",onClick:()=>r.resetForm(),children:"Cancel"})]}),c.review!==""&&n.jsxs(xn,{children:[n.jsx(fn,{"data-edit":l.toString(),type:"button",onClick:()=>{a(!1),i(!0)},children:n.jsx(ct,{})}),n.jsx(gn,{type:"button",onClick:()=>{window.localStorage.setItem(Z,JSON.stringify({rating:5,review:""})),m({review:""}),a(!1),r.resetForm()},children:n.jsx(ln,{})})]}),l&&c.review!==""&&n.jsxs(pe,{children:[n.jsx(ue,{type:"submit",children:"Edit"}),n.jsx(he,{type:"button",onClick:()=>r.resetForm(),children:"Cancel"})]})]})]})},bn="/GooseTrack-with-backend-3.0/assets/user-c5327e69.jpg",yn=({onClickModal:e,modal:t})=>{const o=ye(),[a,l]=h.useState(""),i=ce(d=>d.theme.lightTheme),c=ce(Ye),m=()=>{o(et())},{pathname:r}=Ke();return h.useEffect(()=>{switch(r){case"/account":return l("User Profile");case"/statistics":return l("Statistics");case"/calendar":return l("Calendar")}},[r]),n.jsxs(n.Fragment,{children:[n.jsxs(Zt,{children:[n.jsx(Kt,{children:a}),n.jsxs(Xt,{children:[n.jsx(Qt,{type:"button",onClick:e,children:"Feedback"}),n.jsxs(Yt,{children:[n.jsx(en,{onClick:m,children:i?n.jsx(lt,{}):n.jsx(Jt,{})}),n.jsx(tn,{children:c==null?void 0:c.userName}),n.jsx(nn,{src:bn,alt:"Img User",loading:"lazy",width:"32"})]})]})]}),t&&n.jsx(Qe,{onClose:e,children:n.jsx(vn,{})})]})};function wn(e){return W({tag:"svg",attr:{viewBox:"0 0 24 24",strokeWidth:"2",stroke:"currentColor",fill:"none",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"path",attr:{stroke:"none",d:"M0 0h24v24H0z",fill:"none"}},{tag:"path",attr:{d:"M11.5 21h-5.5a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v6"}},{tag:"path",attr:{d:"M16 3v4"}},{tag:"path",attr:{d:"M8 3v4"}},{tag:"path",attr:{d:"M4 11h16"}},{tag:"path",attr:{d:"M15 19l2 2l4 -4"}}]})(e)}function jn(e){return W({tag:"svg",attr:{viewBox:"0 0 24 24",strokeWidth:"2",stroke:"currentColor",fill:"none",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"path",attr:{stroke:"none",d:"M0 0h24v24H0z",fill:"none"}},{tag:"path",attr:{d:"M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0"}},{tag:"path",attr:{d:"M6 21v-2a4 4 0 0 1 4 -4h4"}},{tag:"path",attr:{d:"M15 19l2 2l4 -4"}}]})(e)}const kn=s.aside`
