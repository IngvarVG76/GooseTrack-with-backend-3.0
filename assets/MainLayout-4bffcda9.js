...
`,Gn=()=>{const[e,t]=h.useState(!1),[o,a]=h.useState(!1),l=h.useCallback(()=>{a(!o),o?document.body.style.overflow="auto":document.body.style.overflow="hidden"},[o]),i=h.useCallback(()=>{t(!e),e?document.body.style.overflow="auto":document.body.style.overflow="hidden"},[e]);return n.jsxs(Tn,{children:[n.jsxs(An,{children:[n.jsx(On,{type:"button",onClick:i,children:n.jsx(qt,{})}),n.jsx(Pn,{onClickMenu:i,nav:e})]}),n.jsxs(En,{children:[n.jsx(yn,{onClickModal:l,modal:o}),n.jsx(h.Suspense,{children:n.jsx(it,{})})]})]})};export{Gn as default};
