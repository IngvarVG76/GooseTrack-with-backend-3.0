import{s as i,n as d,v as g,w as m,x as _,m as h,p as y,r as b,j as r,o as a,y as k}from"./index-7a8beb88.js";import{t as w,a as v,s as M,b as $}from"./index-9b0aa46e.js";const j=i(g)`
  font-size: 16px;
...
`,I=({activePage:e})=>{const o=h(),n=y(),s=t=>{t=a(new Date(t),"dd-MMMM-yyyy"),n(`/calendar/day/${t}`)},p=b.forwardRef(function({value:c,onClick:f},u){return r.jsx(z,{onClick:f,ref:u,children:e==="month"?a(o,"MMMM yyyy"):a(o," dd MMM yyyy")})});return r.jsxs("div",{children:[r.jsx(w,{selected:o,onChange:t=>s(t),customInput:r.jsx(p,{}),calendarStartDay:1,formatWeekDay:t=>t.slice(0,1)}),r.jsx(A,{})]})},B=({activePage:e})=>{const o=y(),n=h(),s=()=>{const t=a(v(n,1),"MMMM-yyy"),c=a(k(n,1),"d-MMMM-yyy");o(e==="month"?`/calendar/month/${t}`:`/calendar/day/${c}`)},p=()=>{const t=a(M(n,1),"MMMM-yyy"),c=a($(n,1),"d-MMMM-yyy");o(e==="month"?`/calendar/month/${t}`:`/calendar/day/${c}`)};return r.jsxs(D,{children:[r.jsx(I,{activePage:e}),r.jsxs("div",{children:[r.jsx(x,{$direction:"back",$back:!0,onClick:()=>p(),children:r.jsx(j,{})}),r.jsx(x,{$direction:"forward",onClick:()=>s(),children:r.jsx(C,{})})]})]})};export{B as C};
