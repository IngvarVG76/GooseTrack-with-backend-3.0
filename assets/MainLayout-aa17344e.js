...
`,Nt=r.button`
  ...
  border: none;
  font-size: 16px;
`,Tt=e=>e.reviews.reviews,Et=({modal:e,onClickModal:n})=>{const i=A(),o=C(Tt),[s,a]=c.useState(!1),[l,u]=c.useState(!1),[d,p]=c.useState(!0),f={textReview:(o==null?void 0:o.text)||"",rating:(o==null?void 0:o.rating)||5},x=re({initialValues:f,enableReinitialize:!0,validationSchema:ae({textReview:se().max(300,"Must be 300 characters or less").trim().required("Fill in the field! Your feedback is very important to us"),rating:ce().required()}),onSubmit:({textReview:v,rating:h})=>{const g=v.trim(),j=l?de({text:g,rating:h}):le({text:g,rating:h});u(!1),n(),i(j)}}),m=c.useCallback(()=>{i(pe())},[i]);c.useEffect(()=>{e&&m()},[e,m]);const w=()=>{i(ue()),a(!0),u(!1),x.setFieldValue("textReview",""),n()};return t.jsxs(Ct,{children:[t.jsx(At,{children:"Rating"}),t.jsx(tt,{spacing:1,children:t.jsx(ze,{disabled:d&&!!(o!=null&&o.text),name:"text-feedback",value:x.values.rating,onChange:(v,h)=>{x.setFieldValue("rating",h)},precision:.5,emptyIcon:t.jsx(V,{style:{opacity:.55},fontSize:"inherit"})})}),t.jsxs(Rt,{onSubmit:x.handleSubmit,children:[t.jsx("label",{htmlFor:"firstName",children:t.jsx(St,{children:"Review"})}),t.jsx(Bt,{"data-error":x.errors.textReview,id:"textReview",name:"textReview",type:"text",disabled:d&&!!(o!=null&&o.text),placeholder:"Enter text",onChange:x.handleChange,onBlur:x.onBlur,value:x.values.textReview}),x.errors.textReview&&t.jsx(Ft,{children:x.errors.textReview}),(s||!(o!=null&&o.text))&&t.jsxs(M,{children:[t.jsx(N,{type:"submit",onClick:()=>{a(!1)},children:"Save"}),t.jsx(T,{type:"button",onClick:()=>{x.resetForm()},children:"Cancel"})]}),!!(o!=null&&o.text)&&t.jsxs(zt,{children:[t.jsx(Mt,{"data-edit":l.toString(),type:"button",onClick:()=>{p(!1),u(!0)},children:t.jsx(Me,{})}),t.jsx(Nt,{type:"button",onClick:w,children:t.jsx(kt,{})})]}),l&&t.jsxs(M,{children:[t.jsx(N,{type:"submit",children:"Edit"}),t.jsx(T,{type:"button",onClick:()=>{x.resetForm()},children:"Cancel"})]})]})]})},Lt=({onClickModal:e,modal:n})=>{const i=A(),[o,s]=c.useState(""),a=C(p=>p.theme.lightTheme),l=C(xe),{pathname:u}=he();c.useEffect(()=>{switch(u){case"/account":return s("User Profile");case"/statistics":return s("Statistics");default:s("Calendar");break}},[u]);const d=()=>{i(fe())};return t.jsxs(t.Fragment,{children:[t.jsxs(rt,{children:[t.jsx(ht,{children:u.includes("/day")?t.jsxs(t.Fragment,{children:[t.jsx("img",{src:it,alt:"company logo"}),t.jsxs("div",{children:[t.jsx(F,{children:"Calendar"}),t.jsxs(mt,{children:[t.jsx("span",{children:"Let go"})," of the past and focus on the present!"]})]})]}):t.jsx(F,{children:o})}),t.jsxs(at,{children:[t.jsx(ct,{type:"button",onClick:e,children:"Feedback"}),t.jsxs(st,{children:[t.jsx(dt,{onClick:d,children:a?t.jsx(je,{}):t.jsx(ot,{})}),t.jsx(lt,{children:l==null?void 0:l.userName}),t.jsx(pt,{children:l!=null&&l.avatarURL?t.jsx(ut,{src:l==null?void 0:l.avatarURL,alt:"Img User",loading:"lazy",width:"32"}):t.jsx(xt,{})})]})]})]}),n&&t.jsx(me,{onClose:e,children:t.jsx(Et,{modal:n,onClickModal:e})})]})};function Pt(e){return b({tag:"svg",attr:{viewBox:"0 0 24 24",strokeWidth:"2",stroke:"currentColor",fill:"none",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"path",attr:{stroke:"none",d:"M0 0h24v24H0z",fill:"none"}},{tag:"path",attr:{d:"M11.5 21h-5.5a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v6"}},{tag:"path",attr:{d:"M16 3v4"}},{tag:"path",attr:{d:"M8 3v4"}},{tag:"path",attr:{d:"M4 11h16"}},{tag:"path",attr:{d:"M15 19l2 2l4 -4"}}]})(e)}function Ot(e){return b({tag:"svg",attr:{viewBox:"0 0 24 24",strokeWidth:"2",stroke:"currentColor",fill:"none",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"path",attr:{stroke:"none",d:"M0 0h24v24H0z",fill:"none"}},{tag:"path",attr:{d:"M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0"}},{tag:"path",attr:{d:"M6 21v-2a4 4 0 0 1 4 -4h4"}},{tag:"path",attr:{d:"M15 19l2 2l4 -4"}}]})(e)}const Vt=r.aside`
...
`,Qt="/GooseTrack-with-backend-3.0/assets/goose-b174e7d2.png",Xt=({onClickMenu:e,nav:n,setNavOpen:i})=>{const o=A(),s=u=>{u.target===u.currentTarget&&e()},a=[{name:"My account",icon:t.jsx(Ot,{}),to:"/account"},{name:"Calendar",icon:t.jsx(Pt,{}),to:"/calendar"},{name:"Statistics",icon:t.jsx(ke,{}),to:"/statistics"}],l=()=>{i(!1),o(ve())};return t.jsxs(t.Fragment,{children:[n&&t.jsx(Gt,{onClick:s}),t.jsxs(Vt,{"data-isopenmenu":n.toString(),children:[t.jsxs("div",{children:[t.jsxs(Ht,{children:[t.jsx(Wt,{src:Qt,alt:"gosse",width:"36"}),t.jsx(It,{children:"GooseTrack"}),t.jsx(Ut,{type:"button",onClick:e,children:t.jsx(be,{})})]}),t.jsx(Zt,{children:"User Panel"}),t.jsx("nav",{children:t.jsx(qt,{children:a.map(({name:u,icon:d,to:p})=>t.jsx(Dt,{children:t.jsxs(Yt,{activeclassname:"active",to:p,children:[d,u]})},u))})})]}),t.jsxs(Kt,{className:"log_out",type:"button",onClick:l,children:["Log out ",t.jsx(Ne,{})]})]})]})},$t=r.div`
...
`,an=()=>{const[e,n]=c.useState(!1),[i,o]=c.useState(!1),s=c.useCallback(()=>{o(!i),i?document.body.style.overflow="auto":document.body.style.overflow="hidden"},[i]),a=()=>n(!e);return c.useEffect(()=>{e?document.body.style.overflow="hidden":document.body.style.overflow="auto"},[e]),t.jsxs($t,{children:[t.jsxs(Jt,{children:[t.jsx(en,{type:"button",onClick:a,children:t.jsx(nt,{})}),t.jsx(Xt,{onClickMenu:a,nav:e,setNavOpen:n})]}),t.jsxs(_t,{children:[t.jsx(Lt,{onClickModal:s,modal:i}),t.jsx(c.Suspense,{children:t.jsx(we,{})})]})]})};export{an as default};
